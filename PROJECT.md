...
| 6 | `add-learned-recovery-classifier` | In progress | Replace the rule-based failure classifier with one learned from the telemetry recovery dataset. The declarative task contract keeps this seam clean. |
